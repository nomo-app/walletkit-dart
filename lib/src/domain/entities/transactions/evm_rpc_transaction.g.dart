...
part of 'evm_rpc_transaction.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class EvmRpcTransactionAdapter extends TypeAdapter<EvmRpcTransaction> {
  @override
  final int typeId = 22;

  @override
  EvmRpcTransaction read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, EvmRpcTransaction obj) {
    writer
      ..writeByte(12)
      ..writeByte(11)
      ..write(obj.input)
  ...
  bool operator ==(Object other) =>
      ...
      other is EvmRpcTransactionAdapter &&
