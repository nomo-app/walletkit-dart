...
part of 'etherscan_transaction.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class EtherscanTransactionAdapter extends TypeAdapter<EtherscanTransaction> {
  @override
  final int typeId = 1;

  @override
  EtherscanTransaction read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, EtherscanTransaction obj) {
    writer
      ..writeByte(12)
      ..writeByte(11)
      ..write(obj.input)
  ...
  bool operator ==(Object other) =>
      ...
      other is EtherscanTransactionAdapter &&
