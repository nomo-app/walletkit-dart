...
final $typed_data.Uint8List returnDescriptor = $convert
    .base64Decode('CgZSZXR1cm4SFgoGcmVzdWx0GAEgASgIUgZyZXN1bHQSMgoEY29kZRgCIAEoDjIeLnByb3RvY2'
...
final $typed_data.Uint8List blockReferenceDescriptor = $convert
    .base64Decode('Cg5CbG9ja1JlZmVyZW5jZRIbCglibG9ja19udW0YASABKANSCGJsb2NrTnVtEh0KCmJsb2NrX2'
...
final $typed_data.Uint8List witnessListDescriptor = $convert
    .base64Decode('CgtXaXRuZXNzTGlzdBIvCgl3aXRuZXNzZXMYASADKAsyES5wcm90b2NvbC5XaXRuZXNzUgl3aX'
        'RuZXNzZXM=');
...
final $typed_data.Uint8List proposalListDescriptor = $convert
    .base64Decode('CgxQcm9wb3NhbExpc3QSMAoJcHJvcG9zYWxzGAEgAygLMhIucHJvdG9jb2wuUHJvcG9zYWxSCX'
        'Byb3Bvc2Fscw==');
...
final $typed_data.Uint8List exchangeListDescriptor = $convert
    .base64Decode('CgxFeGNoYW5nZUxpc3QSMAoJZXhjaGFuZ2VzGAEgAygLMhIucHJvdG9jb2wuRXhjaGFuZ2VSCW'
        'V4Y2hhbmdlcw==');
...
final $typed_data.Uint8List assetIssueListDescriptor = $convert
    .base64Decode('Cg5Bc3NldElzc3VlTGlzdBI8Cgphc3NldElzc3VlGAEgAygLMhwucHJvdG9jb2wuQXNzZXRJc3'
...
final $typed_data.Uint8List blockListDescriptor =
    $convert.base64Decode('CglCbG9ja0xpc3QSJQoFYmxvY2sYASADKAsyDy5wcm90b2NvbC5CbG9ja1IFYmxvY2s=');
...
final $typed_data.Uint8List transactionListDescriptor = $convert
    .base64Decode('Cg9UcmFuc2FjdGlvbkxpc3QSNwoLdHJhbnNhY3Rpb24YASADKAsyFS5wcm90b2NvbC5UcmFuc2'
...
final $typed_data.Uint8List transactionIdListDescriptor =
    $convert.base64Decode('ChFUcmFuc2FjdGlvbklkTGlzdBISCgR0eElkGAEgAygJUgR0eElk');
...
final $typed_data.Uint8List delegatedResourceMessageDescriptor = $convert
    .base64Decode('ChhEZWxlZ2F0ZWRSZXNvdXJjZU1lc3NhZ2USIAoLZnJvbUFkZHJlc3MYASABKAxSC2Zyb21BZG'
...
final $typed_data.Uint8List delegatedResourceListDescriptor = $convert
    .base64Decode('ChVEZWxlZ2F0ZWRSZXNvdXJjZUxpc3QSSQoRZGVsZWdhdGVkUmVzb3VyY2UYASADKAsyGy5wcm'
...
final $typed_data.Uint8List getAvailableUnfreezeCountRequestMessageDescriptor = $convert
    .base64Decode('CidHZXRBdmFpbGFibGVVbmZyZWV6ZUNvdW50UmVxdWVzdE1lc3NhZ2USIwoNb3duZXJfYWRkcm'
...
final $typed_data.Uint8List getAvailableUnfreezeCountResponseMessageDescriptor = $convert
    .base64Decode('CihHZXRBdmFpbGFibGVVbmZyZWV6ZUNvdW50UmVzcG9uc2VNZXNzYWdlEhQKBWNvdW50GAEgAS'
        'gDUgVjb3VudA==');
...
final $typed_data.Uint8List canDelegatedMaxSizeRequestMessageDescriptor = $convert
    .base64Decode('CiFDYW5EZWxlZ2F0ZWRNYXhTaXplUmVxdWVzdE1lc3NhZ2USEgoEdHlwZRgBIAEoBVIEdHlwZR'
...
final $typed_data.Uint8List canDelegatedMaxSizeResponseMessageDescriptor = $convert
    .base64Decode('CiJDYW5EZWxlZ2F0ZWRNYXhTaXplUmVzcG9uc2VNZXNzYWdlEhkKCG1heF9zaXplGAEgASgDUg'
        'dtYXhTaXpl');
...
final $typed_data.Uint8List canWithdrawUnfreezeAmountRequestMessageDescriptor = $convert
    .base64Decode('CidDYW5XaXRoZHJhd1VuZnJlZXplQW1vdW50UmVxdWVzdE1lc3NhZ2USIwoNb3duZXJfYWRkcm'
...
final $typed_data.Uint8List canWithdrawUnfreezeAmountResponseMessageDescriptor = $convert
    .base64Decode('CihDYW5XaXRoZHJhd1VuZnJlZXplQW1vdW50UmVzcG9uc2VNZXNzYWdlEhYKBmFtb3VudBgBIA'
        'EoA1IGYW1vdW50');
...
final $typed_data.Uint8List pricesResponseMessageDescriptor =
    $convert.base64Decode('ChVQcmljZXNSZXNwb25zZU1lc3NhZ2USFgoGcHJpY2VzGAEgASgJUgZwcmljZXM=');
...
final $typed_data.Uint8List nodeListDescriptor =
    $convert.base64Decode('CghOb2RlTGlzdBIkCgVub2RlcxgBIAMoCzIOLnByb3RvY29sLk5vZGVSBW5vZGVz');
...
final $typed_data.Uint8List nodeDescriptor =
    $convert.base64Decode('CgROb2RlEisKB2FkZHJlc3MYASABKAsyES5wcm90b2NvbC5BZGRyZXNzUgdhZGRyZXNz');
...
final $typed_data.Uint8List addressDescriptor =
    $convert.base64Decode('CgdBZGRyZXNzEhIKBGhvc3QYASABKAxSBGhvc3QSEgoEcG9ydBgCIAEoBVIEcG9ydA==');
...
final $typed_data.Uint8List timeMessageDescriptor = $convert
    .base64Decode('CgtUaW1lTWVzc2FnZRIwChNiZWdpbkluTWlsbGlzZWNvbmRzGAEgASgDUhNiZWdpbkluTWlsbG'
...
final $typed_data.Uint8List blockReqDescriptor = $convert
    .base64Decode('CghCbG9ja1JlcRIaCglpZF9vcl9udW0YASABKAlSB2lkT3JOdW0SFgoGZGV0YWlsGAIgASgIUg'
        'ZkZXRhaWw=');
...
final $typed_data.Uint8List blockLimitDescriptor = $convert
    .base64Decode('CgpCbG9ja0xpbWl0EhoKCHN0YXJ0TnVtGAEgASgDUghzdGFydE51bRIWCgZlbmROdW0YAiABKA'
        'NSBmVuZE51bQ==');
...
final $typed_data.Uint8List transactionLimitDescriptor = $convert
    .base64Decode('ChBUcmFuc2FjdGlvbkxpbWl0EiQKDXRyYW5zYWN0aW9uSWQYASABKAxSDXRyYW5zYWN0aW9uSW'
...
final $typed_data.Uint8List accountPaginatedDescriptor = $convert
    .base64Decode('ChBBY2NvdW50UGFnaW5hdGVkEisKB2FjY291bnQYASABKAsyES5wcm90b2NvbC5BY2NvdW50Ug'
...
final $typed_data.Uint8List timePaginatedMessageDescriptor = $convert
    .base64Decode('ChRUaW1lUGFnaW5hdGVkTWVzc2FnZRI3Cgt0aW1lTWVzc2FnZRgBIAEoCzIVLnByb3RvY29sLl'
...
final $typed_data.Uint8List accountNetMessageDescriptor = $convert
    .base64Decode('ChFBY2NvdW50TmV0TWVzc2FnZRIgCgtmcmVlTmV0VXNlZBgBIAEoA1ILZnJlZU5ldFVzZWQSIg'
...
final $typed_data.Uint8List accountResourceMessageDescriptor = $convert
    .base64Decode('ChZBY2NvdW50UmVzb3VyY2VNZXNzYWdlEiAKC2ZyZWVOZXRVc2VkGAEgASgDUgtmcmVlTmV0VX'
...
final $typed_data.Uint8List paginatedMessageDescriptor = $convert
    .base64Decode('ChBQYWdpbmF0ZWRNZXNzYWdlEhYKBm9mZnNldBgBIAEoA1IGb2Zmc2V0EhQKBWxpbWl0GAIgAS'
        'gDUgVsaW1pdA==');
...
final $typed_data.Uint8List transactionExtentionDescriptor = $convert
    .base64Decode('ChRUcmFuc2FjdGlvbkV4dGVudGlvbhI3Cgt0cmFuc2FjdGlvbhgBIAEoCzIVLnByb3RvY29sLl'
...
final $typed_data.Uint8List estimateEnergyMessageDescriptor = $convert
    .base64Decode('ChVFc3RpbWF0ZUVuZXJneU1lc3NhZ2USKAoGcmVzdWx0GAEgASgLMhAucHJvdG9jb2wuUmV0dX'
...
final $typed_data.Uint8List blockExtentionDescriptor = $convert
    .base64Decode('Cg5CbG9ja0V4dGVudGlvbhJCCgx0cmFuc2FjdGlvbnMYASADKAsyHi5wcm90b2NvbC5UcmFuc2'
...
final $typed_data.Uint8List blockListExtentionDescriptor = $convert
    .base64Decode('ChJCbG9ja0xpc3RFeHRlbnRpb24SLgoFYmxvY2sYASADKAsyGC5wcm90b2NvbC5CbG9ja0V4dG'
        'VudGlvblIFYmxvY2s=');
...
final $typed_data.Uint8List transactionListExtentionDescriptor = $convert
    .base64Decode('ChhUcmFuc2FjdGlvbkxpc3RFeHRlbnRpb24SQAoLdHJhbnNhY3Rpb24YASADKAsyHi5wcm90b2'
...
final $typed_data.Uint8List blockIncrementalMerkleTreeDescriptor = $convert
    .base64Decode('ChpCbG9ja0luY3JlbWVudGFsTWVya2xlVHJlZRIWCgZudW1iZXIYASABKANSBm51bWJlchI/Cg'
...
final $typed_data.Uint8List transactionSignWeightDescriptor = $convert
    .base64Decode('ChVUcmFuc2FjdGlvblNpZ25XZWlnaHQSNAoKcGVybWlzc2lvbhgBIAEoCzIULnByb3RvY29sLl'
...
final $typed_data.Uint8List transactionApprovedListDescriptor = $convert
    .base64Decode('ChdUcmFuc2FjdGlvbkFwcHJvdmVkTGlzdBIjCg1hcHByb3ZlZF9saXN0GAIgAygMUgxhcHByb3'
...
final $typed_data.Uint8List ivkDecryptParametersDescriptor = $convert
    .base64Decode('ChRJdmtEZWNyeXB0UGFyYW1ldGVycxIqChFzdGFydF9ibG9ja19pbmRleBgBIAEoA1IPc3Rhcn'
...
final $typed_data.Uint8List ivkDecryptAndMarkParametersDescriptor = $convert
    .base64Decode('ChtJdmtEZWNyeXB0QW5kTWFya1BhcmFtZXRlcnMSKgoRc3RhcnRfYmxvY2tfaW5kZXgYASABKA'
...
final $typed_data.Uint8List ovkDecryptParametersDescriptor = $convert
    .base64Decode('ChRPdmtEZWNyeXB0UGFyYW1ldGVycxIqChFzdGFydF9ibG9ja19pbmRleBgBIAEoA1IPc3Rhcn'
...
final $typed_data.Uint8List decryptNotesDescriptor = $convert
    .base64Decode('CgxEZWNyeXB0Tm90ZXMSNwoHbm90ZVR4cxgBIAMoCzIdLnByb3RvY29sLkRlY3J5cHROb3Rlcy'
...
final $typed_data.Uint8List decryptNotesMarkedDescriptor = $convert
    .base64Decode('ChJEZWNyeXB0Tm90ZXNNYXJrZWQSPQoHbm90ZVR4cxgBIAMoCzIjLnByb3RvY29sLkRlY3J5cH'
...
final $typed_data.Uint8List noteDescriptor = $convert
    .base64Decode('CgROb3RlEhQKBXZhbHVlGAEgASgDUgV2YWx1ZRInCg9wYXltZW50X2FkZHJlc3MYAiABKAlSDn'
...
final $typed_data.Uint8List spendNoteDescriptor = $convert
    .base64Decode('CglTcGVuZE5vdGUSIgoEbm90ZRgDIAEoCzIOLnByb3RvY29sLk5vdGVSBG5vdGUSFAoFYWxwaG'
...
final $typed_data.Uint8List receiveNoteDescriptor =
    $convert.base64Decode('CgtSZWNlaXZlTm90ZRIiCgRub3RlGAEgASgLMg4ucHJvdG9jb2wuTm90ZVIEbm90ZQ==');
...
final $typed_data.Uint8List privateParametersDescriptor = $convert
    .base64Decode('ChFQcml2YXRlUGFyYW1ldGVycxI4Chh0cmFuc3BhcmVudF9mcm9tX2FkZHJlc3MYASABKAxSFn'
...
final $typed_data.Uint8List privateParametersWithoutAskDescriptor = $convert
    .base64Decode('ChtQcml2YXRlUGFyYW1ldGVyc1dpdGhvdXRBc2sSOAoYdHJhbnNwYXJlbnRfZnJvbV9hZGRyZX'
...
final $typed_data.Uint8List spendAuthSigParametersDescriptor = $convert
    .base64Decode('ChZTcGVuZEF1dGhTaWdQYXJhbWV0ZXJzEhAKA2FzaxgBIAEoDFIDYXNrEhcKB3R4X2hhc2gYAi'
...
final $typed_data.Uint8List nfParametersDescriptor = $convert
    .base64Decode('CgxOZlBhcmFtZXRlcnMSIgoEbm90ZRgBIAEoCzIOLnByb3RvY29sLk5vdGVSBG5vdGUSPAoHdm'
...
final $typed_data.Uint8List expandedSpendingKeyMessageDescriptor = $convert
    .base64Decode('ChpFeHBhbmRlZFNwZW5kaW5nS2V5TWVzc2FnZRIQCgNhc2sYASABKAxSA2FzaxIQCgNuc2sYAi'
...
final $typed_data.Uint8List viewingKeyMessageDescriptor =
    $convert.base64Decode('ChFWaWV3aW5nS2V5TWVzc2FnZRIOCgJhaxgBIAEoDFICYWsSDgoCbmsYAiABKAxSAm5r');
...
final $typed_data.Uint8List incomingViewingKeyMessageDescriptor =
    $convert.base64Decode('ChlJbmNvbWluZ1ZpZXdpbmdLZXlNZXNzYWdlEhAKA2l2axgBIAEoDFIDaXZr');
...
final $typed_data.Uint8List incomingViewingKeyDiversifierMessageDescriptor = $convert
    .base64Decode('CiRJbmNvbWluZ1ZpZXdpbmdLZXlEaXZlcnNpZmllck1lc3NhZ2USNQoDaXZrGAEgASgLMiMucH'
...
final $typed_data.Uint8List paymentAddressMessageDescriptor = $convert
    .base64Decode('ChVQYXltZW50QWRkcmVzc01lc3NhZ2USKgoBZBgBIAEoCzIcLnByb3RvY29sLkRpdmVyc2lmaW'
...
final $typed_data.Uint8List shieldedAddressInfoDescriptor = $convert
    .base64Decode('ChNTaGllbGRlZEFkZHJlc3NJbmZvEg4KAnNrGAEgASgMUgJzaxIQCgNhc2sYAiABKAxSA2Fzax'
...
final $typed_data.Uint8List noteParametersDescriptor = $convert
    .base64Decode('Cg5Ob3RlUGFyYW1ldGVycxIOCgJhaxgBIAEoDFICYWsSDgoCbmsYAiABKAxSAm5rEiIKBG5vdG'
...
final $typed_data.Uint8List spendResultDescriptor = $convert
    .base64Decode('CgtTcGVuZFJlc3VsdBIWCgZyZXN1bHQYASABKAhSBnJlc3VsdBIYCgdtZXNzYWdlGAIgASgJUg'
        'dtZXNzYWdl');
...
final $typed_data.Uint8List transactionInfoListDescriptor = $convert
    .base64Decode('ChNUcmFuc2FjdGlvbkluZm9MaXN0EkMKD3RyYW5zYWN0aW9uSW5mbxgBIAMoCzIZLnByb3RvY2'
...
final $typed_data.Uint8List spendNoteTRC20Descriptor = $convert
    .base64Decode('Cg5TcGVuZE5vdGVUUkMyMBIiCgRub3RlGAEgASgLMg4ucHJvdG9jb2wuTm90ZVIEbm90ZRIUCg'
...
final $typed_data.Uint8List privateShieldedTRC20ParametersDescriptor = $convert
    .base64Decode('Ch5Qcml2YXRlU2hpZWxkZWRUUkMyMFBhcmFtZXRlcnMSEAoDYXNrGAEgASgMUgNhc2sSEAoDbn'
...
final $typed_data.Uint8List privateShieldedTRC20ParametersWithoutAskDescriptor = $convert
    .base64Decode('CihQcml2YXRlU2hpZWxkZWRUUkMyMFBhcmFtZXRlcnNXaXRob3V0QXNrEg4KAmFrGAEgASgMUg'
...
final $typed_data.Uint8List shieldedTRC20ParametersDescriptor = $convert
    .base64Decode('ChdTaGllbGRlZFRSQzIwUGFyYW1ldGVycxJHChFzcGVuZF9kZXNjcmlwdGlvbhgBIAMoCzIaLn'
...
final $typed_data.Uint8List ivkDecryptTRC20ParametersDescriptor = $convert
    .base64Decode('ChlJdmtEZWNyeXB0VFJDMjBQYXJhbWV0ZXJzEioKEXN0YXJ0X2Jsb2NrX2luZGV4GAEgASgDUg'
...
final $typed_data.Uint8List ovkDecryptTRC20ParametersDescriptor = $convert
    .base64Decode('ChlPdmtEZWNyeXB0VFJDMjBQYXJhbWV0ZXJzEioKEXN0YXJ0X2Jsb2NrX2luZGV4GAEgASgDUg'
        '9zdGFydEJsb2NrSW5kZXgSJgoPZW5kX2Jsb2NrX2luZGV4GAIgASgDUg1lbmRCbG9ja0luZGV4'
...
final $typed_data.Uint8List decryptNotesTRC20Descriptor = $convert
    .base64Decode('ChFEZWNyeXB0Tm90ZXNUUkMyMBI8Cgdub3RlVHhzGAEgAygLMiIucHJvdG9jb2wuRGVjcnlwdE'
...
final $typed_data.Uint8List nfTRC20ParametersDescriptor = $convert
    .base64Decode('ChFOZlRSQzIwUGFyYW1ldGVycxIiCgRub3RlGAEgASgLMg4ucHJvdG9jb2wuTm90ZVIEbm90ZR'
...
final $typed_data.Uint8List nullifierResultDescriptor =
    $convert.base64Decode('Cg9OdWxsaWZpZXJSZXN1bHQSGQoIaXNfc3BlbnQYASABKAhSB2lzU3BlbnQ=');
...
final $typed_data.Uint8List shieldedTRC20TriggerContractParametersDescriptor = $convert
    .base64Decode('CiZTaGllbGRlZFRSQzIwVHJpZ2dlckNvbnRyYWN0UGFyYW1ldGVycxJdChlzaGllbGRlZF9UUk'
