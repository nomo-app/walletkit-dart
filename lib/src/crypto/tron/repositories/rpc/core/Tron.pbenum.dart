...
class Transaction_Contract_ContractType extends $pb.ProtobufEnum {
  static const Transaction_Contract_ContractType AccountCreateContract =
      Transaction_Contract_ContractType._(0, _omitEnumNames ? '' : 'AccountCreateContract');
  static const Transaction_Contract_ContractType TransferContract =
      Transaction_Contract_ContractType._(1, _omitEnumNames ? '' : 'TransferContract');
  static const Transaction_Contract_ContractType TransferAssetContract =
      Transaction_Contract_ContractType._(2, _omitEnumNames ? '' : 'TransferAssetContract');
  static const Transaction_Contract_ContractType VoteAssetContract =
      Transaction_Contract_ContractType._(3, _omitEnumNames ? '' : 'VoteAssetContract');
  static const Transaction_Contract_ContractType VoteWitnessContract =
      Transaction_Contract_ContractType._(4, _omitEnumNames ? '' : 'VoteWitnessContract');
  static const Transaction_Contract_ContractType WitnessCreateContract =
      Transaction_Contract_ContractType._(5, _omitEnumNames ? '' : 'WitnessCreateContract');
  static const Transaction_Contract_ContractType AssetIssueContract =
      Transaction_Contract_ContractType._(6, _omitEnumNames ? '' : 'AssetIssueContract');
  static const Transaction_Contract_ContractType WitnessUpdateContract =
      Transaction_Contract_ContractType._(8, _omitEnumNames ? '' : 'WitnessUpdateContract');
  static const Transaction_Contract_ContractType ParticipateAssetIssueContract =
      Transaction_Contract_ContractType._(9, _omitEnumNames ? '' : 'ParticipateAssetIssueContract');
  static const Transaction_Contract_ContractType AccountUpdateContract =
      Transaction_Contract_ContractType._(10, _omitEnumNames ? '' : 'AccountUpdateContract');
  static const Transaction_Contract_ContractType FreezeBalanceContract =
      Transaction_Contract_ContractType._(11, _omitEnumNames ? '' : 'FreezeBalanceContract');
  static const Transaction_Contract_ContractType UnfreezeBalanceContract =
      Transaction_Contract_ContractType._(12, _omitEnumNames ? '' : 'UnfreezeBalanceContract');
  static const Transaction_Contract_ContractType WithdrawBalanceContract =
      Transaction_Contract_ContractType._(13, _omitEnumNames ? '' : 'WithdrawBalanceContract');
  static const Transaction_Contract_ContractType UnfreezeAssetContract =
      Transaction_Contract_ContractType._(14, _omitEnumNames ? '' : 'UnfreezeAssetContract');
  static const Transaction_Contract_ContractType UpdateAssetContract =
      Transaction_Contract_ContractType._(15, _omitEnumNames ? '' : 'UpdateAssetContract');
  static const Transaction_Contract_ContractType ProposalCreateContract =
      Transaction_Contract_ContractType._(16, _omitEnumNames ? '' : 'ProposalCreateContract');
  static const Transaction_Contract_ContractType ProposalApproveContract =
      Transaction_Contract_ContractType._(17, _omitEnumNames ? '' : 'ProposalApproveContract');
  static const Transaction_Contract_ContractType ProposalDeleteContract =
      Transaction_Contract_ContractType._(18, _omitEnumNames ? '' : 'ProposalDeleteContract');
  static const Transaction_Contract_ContractType SetAccountIdContract =
      Transaction_Contract_ContractType._(19, _omitEnumNames ? '' : 'SetAccountIdContract');
  static const Transaction_Contract_ContractType CustomContract =
      Transaction_Contract_ContractType._(20, _omitEnumNames ? '' : 'CustomContract');
  static const Transaction_Contract_ContractType CreateSmartContract =
      Transaction_Contract_ContractType._(30, _omitEnumNames ? '' : 'CreateSmartContract');
  static const Transaction_Contract_ContractType TriggerSmartContract =
      Transaction_Contract_ContractType._(31, _omitEnumNames ? '' : 'TriggerSmartContract');
  static const Transaction_Contract_ContractType GetContract =
      Transaction_Contract_ContractType._(32, _omitEnumNames ? '' : 'GetContract');
  static const Transaction_Contract_ContractType UpdateSettingContract =
      Transaction_Contract_ContractType._(33, _omitEnumNames ? '' : 'UpdateSettingContract');
  static const Transaction_Contract_ContractType ExchangeCreateContract =
      Transaction_Contract_ContractType._(41, _omitEnumNames ? '' : 'ExchangeCreateContract');
  static const Transaction_Contract_ContractType ExchangeInjectContract =
      Transaction_Contract_ContractType._(42, _omitEnumNames ? '' : 'ExchangeInjectContract');
  static const Transaction_Contract_ContractType ExchangeWithdrawContract =
      Transaction_Contract_ContractType._(43, _omitEnumNames ? '' : 'ExchangeWithdrawContract');
  static const Transaction_Contract_ContractType ExchangeTransactionContract =
      Transaction_Contract_ContractType._(44, _omitEnumNames ? '' : 'ExchangeTransactionContract');
  static const Transaction_Contract_ContractType UpdateEnergyLimitContract =
      Transaction_Contract_ContractType._(45, _omitEnumNames ? '' : 'UpdateEnergyLimitContract');
  static const Transaction_Contract_ContractType AccountPermissionUpdateContract =
  ...
  static const Transaction_Contract_ContractType ClearABIContract =
      Transaction_Contract_ContractType._(48, _omitEnumNames ? '' : 'ClearABIContract');
  static const Transaction_Contract_ContractType UpdateBrokerageContract =
      Transaction_Contract_ContractType._(49, _omitEnumNames ? '' : 'UpdateBrokerageContract');
  static const Transaction_Contract_ContractType ShieldedTransferContract =
      Transaction_Contract_ContractType._(51, _omitEnumNames ? '' : 'ShieldedTransferContract');
  static const Transaction_Contract_ContractType MarketSellAssetContract =
      Transaction_Contract_ContractType._(52, _omitEnumNames ? '' : 'MarketSellAssetContract');
  static const Transaction_Contract_ContractType MarketCancelOrderContract =
      Transaction_Contract_ContractType._(53, _omitEnumNames ? '' : 'MarketCancelOrderContract');
  static const Transaction_Contract_ContractType FreezeBalanceV2Contract =
      Transaction_Contract_ContractType._(54, _omitEnumNames ? '' : 'FreezeBalanceV2Contract');
  static const Transaction_Contract_ContractType UnfreezeBalanceV2Contract =
      Transaction_Contract_ContractType._(55, _omitEnumNames ? '' : 'UnfreezeBalanceV2Contract');
  static const Transaction_Contract_ContractType WithdrawExpireUnfreezeContract =
      Transaction_Contract_ContractType._(
          56, _omitEnumNames ? '' : 'WithdrawExpireUnfreezeContract');
  static const Transaction_Contract_ContractType DelegateResourceContract =
      Transaction_Contract_ContractType._(57, _omitEnumNames ? '' : 'DelegateResourceContract');
  static const Transaction_Contract_ContractType UnDelegateResourceContract =
      Transaction_Contract_ContractType._(58, _omitEnumNames ? '' : 'UnDelegateResourceContract');
  static const Transaction_Contract_ContractType CancelAllUnfreezeV2Contract =
      Transaction_Contract_ContractType._(59, _omitEnumNames ? '' : 'CancelAllUnfreezeV2Contract');
  ...
  static final $core.Map<$core.int, Transaction_Contract_ContractType> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class Transaction_Result_contractResult extends $pb.ProtobufEnum {
  ...
  static const Transaction_Result_contractResult BAD_JUMP_DESTINATION =
      Transaction_Result_contractResult._(3, _omitEnumNames ? '' : 'BAD_JUMP_DESTINATION');
  static const Transaction_Result_contractResult OUT_OF_MEMORY =
      Transaction_Result_contractResult._(4, _omitEnumNames ? '' : 'OUT_OF_MEMORY');
  static const Transaction_Result_contractResult PRECOMPILED_CONTRACT =
      Transaction_Result_contractResult._(5, _omitEnumNames ? '' : 'PRECOMPILED_CONTRACT');
  static const Transaction_Result_contractResult STACK_TOO_SMALL =
      Transaction_Result_contractResult._(6, _omitEnumNames ? '' : 'STACK_TOO_SMALL');
  static const Transaction_Result_contractResult STACK_TOO_LARGE =
      Transaction_Result_contractResult._(7, _omitEnumNames ? '' : 'STACK_TOO_LARGE');
  static const Transaction_Result_contractResult ILLEGAL_OPERATION =
      Transaction_Result_contractResult._(8, _omitEnumNames ? '' : 'ILLEGAL_OPERATION');
  static const Transaction_Result_contractResult STACK_OVERFLOW =
      Transaction_Result_contractResult._(9, _omitEnumNames ? '' : 'STACK_OVERFLOW');
  static const Transaction_Result_contractResult OUT_OF_ENERGY =
      Transaction_Result_contractResult._(10, _omitEnumNames ? '' : 'OUT_OF_ENERGY');
  static const Transaction_Result_contractResult OUT_OF_TIME =
      Transaction_Result_contractResult._(11, _omitEnumNames ? '' : 'OUT_OF_TIME');
  static const Transaction_Result_contractResult JVM_STACK_OVER_FLOW =
      Transaction_Result_contractResult._(12, _omitEnumNames ? '' : 'JVM_STACK_OVER_FLOW');
  ...
  static const Transaction_Result_contractResult TRANSFER_FAILED =
      Transaction_Result_contractResult._(14, _omitEnumNames ? '' : 'TRANSFER_FAILED');
  static const Transaction_Result_contractResult INVALID_CODE =
      Transaction_Result_contractResult._(15, _omitEnumNames ? '' : 'INVALID_CODE');
  ...
  static final $core.Map<$core.int, Transaction_Result_contractResult> _byValue =
      $pb.ProtobufEnum.initByValue(values);
