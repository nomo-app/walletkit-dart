...
final $typed_data.Uint8List reasonCodeDescriptor = $convert.base64Decode(
    'CgpSZWFzb25Db2RlEg0KCVJFUVVFU1RFRBAAEhAKDEJBRF9QUk9UT0NPTBACEhIKDlRPT19NQU'
...
final $typed_data.Uint8List accountIdDescriptor = $convert.base64Decode(
    'CglBY2NvdW50SWQSEgoEbmFtZRgBIAEoDFIEbmFtZRIYCgdhZGRyZXNzGAIgASgMUgdhZGRyZX'
    'Nz');
...
final $typed_data.Uint8List voteDescriptor = $convert.base64Decode(
    'CgRWb3RlEiEKDHZvdGVfYWRkcmVzcxgBIAEoDFILdm90ZUFkZHJlc3MSHQoKdm90ZV9jb3VudB'
...
const Proposal$json = {
  ...
  '2': [
    ...
    {'1': 'parameters', '3': 3, '4': 3, '5': 11, '6': '.protocol.Proposal.ParametersEntry', '10': 'parameters'},
...
final $typed_data.Uint8List proposalDescriptor = $convert.base64Decode(
    'CghQcm9wb3NhbBIfCgtwcm9wb3NhbF9pZBgBIAEoA1IKcHJvcG9zYWxJZBIpChBwcm9wb3Nlcl'
...
final $typed_data.Uint8List exchangeDescriptor = $convert.base64Decode(
    'CghFeGNoYW5nZRIfCgtleGNoYW5nZV9pZBgBIAEoA1IKZXhjaGFuZ2VJZBInCg9jcmVhdG9yX2'
...
final $typed_data.Uint8List marketOrderDescriptor = $convert.base64Decode(
    'CgtNYXJrZXRPcmRlchIZCghvcmRlcl9pZBgBIAEoDFIHb3JkZXJJZBIjCg1vd25lcl9hZGRyZX'
...
final $typed_data.Uint8List marketOrderListDescriptor = $convert.base64Decode(
    'Cg9NYXJrZXRPcmRlckxpc3QSLQoGb3JkZXJzGAEgAygLMhUucHJvdG9jb2wuTWFya2V0T3JkZX'
    'JSBm9yZGVycw==');
...
const MarketOrderPairList$json = {
  ...
  '2': [
    {'1': 'orderPair', '3': 1, '4': 3, '5': 11, '6': '.protocol.MarketOrderPair', '10': 'orderPair'},
  ],
};
...
final $typed_data.Uint8List marketOrderPairListDescriptor = $convert.base64Decode(
    'ChNNYXJrZXRPcmRlclBhaXJMaXN0EjcKCW9yZGVyUGFpchgBIAMoCzIZLnByb3RvY29sLk1hcm'
...
final $typed_data.Uint8List marketOrderPairDescriptor = $convert.base64Decode(
    'Cg9NYXJrZXRPcmRlclBhaXISIgoNc2VsbF90b2tlbl9pZBgBIAEoDFILc2VsbFRva2VuSWQSIA'
...
final $typed_data.Uint8List marketAccountOrderDescriptor = $convert.base64Decode(
    'ChJNYXJrZXRBY2NvdW50T3JkZXISIwoNb3duZXJfYWRkcmVzcxgBIAEoDFIMb3duZXJBZGRyZX'
...
final $typed_data.Uint8List marketPriceDescriptor = $convert.base64Decode(
    'CgtNYXJrZXRQcmljZRIuChNzZWxsX3Rva2VuX3F1YW50aXR5GAEgASgDUhFzZWxsVG9rZW5RdW'
...
final $typed_data.Uint8List marketPriceListDescriptor = $convert.base64Decode(
    'Cg9NYXJrZXRQcmljZUxpc3QSIgoNc2VsbF90b2tlbl9pZBgBIAEoDFILc2VsbFRva2VuSWQSIA'
...
final $typed_data.Uint8List marketOrderIdListDescriptor = $convert.base64Decode(
    'ChFNYXJrZXRPcmRlcklkTGlzdBISCgRoZWFkGAEgASgMUgRoZWFkEhIKBHRhaWwYAiABKAxSBH'
    'RhaWw=');
...
const ChainParameters$json = {
  '1': 'ChainParameters',
  '2': [
    {'1': 'chainParameter', '3': 1, '4': 3, '5': 11, '6': '.protocol.ChainParameters.ChainParameter', '10': 'chainParameter'},
  ],
...
final $typed_data.Uint8List chainParametersDescriptor = $convert.base64Decode(
    'Cg9DaGFpblBhcmFtZXRlcnMSUAoOY2hhaW5QYXJhbWV0ZXIYASADKAsyKC5wcm90b2NvbC5DaG'
...
const Account$json = {
  ...
  '2': [
    ...
    {'1': 'assetV2', '3': 56, '4': 3, '5': 11, '6': '.protocol.Account.AssetV2Entry', '10': 'assetV2'},
    {'1': 'frozen', '3': 7, '4': 3, '5': 11, '6': '.protocol.Account.Frozen', '10': 'frozen'},
    {'1': 'net_usage', '3': 8, '4': 1, '5': 3, '10': 'netUsage'},
    {'1': 'acquired_delegated_frozen_balance_for_bandwidth', '3': 41, '4': 1, '5': 3, '10': 'acquiredDelegatedFrozenBalanceForBandwidth'},
    {'1': 'delegated_frozen_balance_for_bandwidth', '3': 42, '4': 1, '5': 3, '10': 'delegatedFrozenBalanceForBandwidth'},
    {'1': 'old_tron_power', '3': 46, '4': 1, '5': 3, '10': 'oldTronPower'},
    {'1': 'tron_power', '3': 47, '4': 1, '5': 11, '6': '.protocol.Account.Frozen', '10': 'tronPower'},
    ...
    {'1': 'frozen_supply', '3': 16, '4': 3, '5': 11, '6': '.protocol.Account.Frozen', '10': 'frozenSupply'},
    {'1': 'asset_issued_name', '3': 17, '4': 1, '5': 12, '10': 'assetIssuedName'},
    {'1': 'asset_issued_ID', '3': 57, '4': 1, '5': 12, '10': 'assetIssuedID'},
    {'1': 'latest_asset_operation_time', '3': 18, '4': 3, '5': 11, '6': '.protocol.Account.LatestAssetOperationTimeEntry', '10': 'latestAssetOperationTime'},
    {'1': 'latest_asset_operation_timeV2', '3': 58, '4': 3, '5': 11, '6': '.protocol.Account.LatestAssetOperationTimeV2Entry', '10': 'latestAssetOperationTimeV2'},
    {'1': 'free_net_usage', '3': 19, '4': 1, '5': 3, '10': 'freeNetUsage'},
    {'1': 'free_asset_net_usage', '3': 20, '4': 3, '5': 11, '6': '.protocol.Account.FreeAssetNetUsageEntry', '10': 'freeAssetNetUsage'},
    {'1': 'free_asset_net_usageV2', '3': 59, '4': 3, '5': 11, '6': '.protocol.Account.FreeAssetNetUsageV2Entry', '10': 'freeAssetNetUsageV2'},
    ...
    {'1': 'account_resource', '3': 26, '4': 1, '5': 11, '6': '.protocol.Account.AccountResource', '10': 'accountResource'},
    {'1': 'codeHash', '3': 30, '4': 1, '5': 12, '10': 'codeHash'},
    {'1': 'owner_permission', '3': 31, '4': 1, '5': 11, '6': '.protocol.Permission', '10': 'ownerPermission'},
    {'1': 'witness_permission', '3': 32, '4': 1, '5': 11, '6': '.protocol.Permission', '10': 'witnessPermission'},
    {'1': 'active_permission', '3': 33, '4': 3, '5': 11, '6': '.protocol.Permission', '10': 'activePermission'},
    {'1': 'frozenV2', '3': 34, '4': 3, '5': 11, '6': '.protocol.Account.FreezeV2', '10': 'frozenV2'},
    {'1': 'unfrozenV2', '3': 35, '4': 3, '5': 11, '6': '.protocol.Account.UnFreezeV2', '10': 'unfrozenV2'},
    {'1': 'delegated_frozenV2_balance_for_bandwidth', '3': 36, '4': 1, '5': 3, '10': 'delegatedFrozenV2BalanceForBandwidth'},
    {'1': 'acquired_delegated_frozenV2_balance_for_bandwidth', '3': 37, '4': 1, '5': 3, '10': 'acquiredDelegatedFrozenV2BalanceForBandwidth'},
  ],
  '3': [Account_Frozen$json, Account_AssetEntry$json, Account_AssetV2Entry$json, Account_LatestAssetOperationTimeEntry$json, Account_LatestAssetOperationTimeV2Entry$json, Account_FreeAssetNetUsageEntry$json, Account_FreeAssetNetUsageV2Entry$json, Account_AccountResource$json, Account_FreezeV2$json, Account_UnFreezeV2$json],
};
...
const Account_AccountResource$json = {
  ...
  '2': [
    ...
    {'1': 'frozen_balance_for_energy', '3': 2, '4': 1, '5': 11, '6': '.protocol.Account.Frozen', '10': 'frozenBalanceForEnergy'},
    {'1': 'latest_consume_time_for_energy', '3': 3, '4': 1, '5': 3, '10': 'latestConsumeTimeForEnergy'},
    {'1': 'acquired_delegated_frozen_balance_for_energy', '3': 4, '4': 1, '5': 3, '10': 'acquiredDelegatedFrozenBalanceForEnergy'},
    {'1': 'delegated_frozen_balance_for_energy', '3': 5, '4': 1, '5': 3, '10': 'delegatedFrozenBalanceForEnergy'},
    {'1': 'storage_limit', '3': 6, '4': 1, '5': 3, '10': 'storageLimit'},
    {'1': 'storage_usage', '3': 7, '4': 1, '5': 3, '10': 'storageUsage'},
    {'1': 'latest_exchange_storage_time', '3': 8, '4': 1, '5': 3, '10': 'latestExchangeStorageTime'},
    {'1': 'energy_window_size', '3': 9, '4': 1, '5': 3, '10': 'energyWindowSize'},
    {'1': 'delegated_frozenV2_balance_for_energy', '3': 10, '4': 1, '5': 3, '10': 'delegatedFrozenV2BalanceForEnergy'},
    {'1': 'acquired_delegated_frozenV2_balance_for_energy', '3': 11, '4': 1, '5': 3, '10': 'acquiredDelegatedFrozenV2BalanceForEnergy'},
...
final $typed_data.Uint8List accountDescriptor = $convert.base64Decode(
    'CgdBY2NvdW50EiEKDGFjY291bnRfbmFtZRgBIAEoDFILYWNjb3VudE5hbWUSKQoEdHlwZRgCIA'
...
const DelegatedResource$json = {
  ...
  '2': [
    ...
    {'1': 'frozen_balance_for_bandwidth', '3': 3, '4': 1, '5': 3, '10': 'frozenBalanceForBandwidth'},
...
final $typed_data.Uint8List delegatedResourceDescriptor = $convert.base64Decode(
    'ChFEZWxlZ2F0ZWRSZXNvdXJjZRISCgRmcm9tGAEgASgMUgRmcm9tEg4KAnRvGAIgASgMUgJ0bx'
...
final $typed_data.Uint8List authorityDescriptor = $convert.base64Decode(
    'CglhdXRob3JpdHkSLQoHYWNjb3VudBgBIAEoCzITLnByb3RvY29sLkFjY291bnRJZFIHYWNjb3'
...
const Permission$json = {
  '1': 'Permission',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.protocol.Permission.PermissionType', '10': 'type'},
...
final $typed_data.Uint8List permissionDescriptor = $convert.base64Decode(
    'CgpQZXJtaXNzaW9uEjcKBHR5cGUYASABKA4yIy5wcm90b2NvbC5QZXJtaXNzaW9uLlBlcm1pc3'
...
final $typed_data.Uint8List witnessDescriptor = $convert.base64Decode(
    'CgdXaXRuZXNzEhgKB2FkZHJlc3MYASABKAxSB2FkZHJlc3MSHAoJdm90ZUNvdW50GAIgASgDUg'
...
final $typed_data.Uint8List votesDescriptor = $convert.base64Decode(
    'CgVWb3RlcxIYCgdhZGRyZXNzGAEgASgMUgdhZGRyZXNzEisKCW9sZF92b3RlcxgCIAMoCzIOLn'
...
final $typed_data.Uint8List tXOutputDescriptor = $convert.base64Decode(
    'CghUWE91dHB1dBIUCgV2YWx1ZRgBIAEoA1IFdmFsdWUSHgoKcHViS2V5SGFzaBgCIAEoDFIKcH'
    'ViS2V5SGFzaA==');
...
final $typed_data.Uint8List tXInputDescriptor = $convert.base64Decode(
    'CgdUWElucHV0EjAKCHJhd19kYXRhGAEgASgLMhUucHJvdG9jb2wuVFhJbnB1dC5yYXdSB3Jhd0'
...
final $typed_data.Uint8List tXOutputsDescriptor = $convert.base64Decode(
    'CglUWE91dHB1dHMSLAoHb3V0cHV0cxgBIAMoCzISLnByb3RvY29sLlRYT3V0cHV0UgdvdXRwdX'
    'Rz');
...
const ResourceReceipt$json = {
  ...
  '2': [
    ...
    {'1': 'result', '3': 7, '4': 1, '5': 14, '6': '.protocol.Transaction.Result.contractResult', '10': 'result'},
...
final $typed_data.Uint8List resourceReceiptDescriptor = $convert.base64Decode(
    'Cg9SZXNvdXJjZVJlY2VpcHQSIQoMZW5lcmd5X3VzYWdlGAEgASgDUgtlbmVyZ3lVc2FnZRIdCg'
...
final $typed_data.Uint8List marketOrderDetailDescriptor = $convert.base64Decode(
    'ChFNYXJrZXRPcmRlckRldGFpbBIiCgxtYWtlck9yZGVySWQYASABKAxSDG1ha2VyT3JkZXJJZB'
...
const Transaction_Contract$json = {
  '1': 'Contract',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.protocol.Transaction.Contract.ContractType', '10': 'type'},
...
const Transaction_Result$json = {
  ...
  '2': [
    ...
    {'1': 'contractRet', '3': 3, '4': 1, '5': 14, '6': '.protocol.Transaction.Result.contractResult', '10': 'contractRet'},
    ...
    {'1': 'exchange_inject_another_amount', '3': 19, '4': 1, '5': 3, '10': 'exchangeInjectAnotherAmount'},
    {'1': 'exchange_withdraw_another_amount', '3': 20, '4': 1, '5': 3, '10': 'exchangeWithdrawAnotherAmount'},
    ...
    {'1': 'orderDetails', '3': 26, '4': 3, '5': 11, '6': '.protocol.MarketOrderDetail', '10': 'orderDetails'},
    {'1': 'withdraw_expire_amount', '3': 27, '4': 1, '5': 3, '10': 'withdrawExpireAmount'},
    {'1': 'cancel_unfreezeV2_amount', '3': 28, '4': 3, '5': 11, '6': '.protocol.Transaction.Result.CancelUnfreezeV2AmountEntry', '10': 'cancelUnfreezeV2Amount'},
  ],
...
const Transaction_raw$json = {
  ...
  '2': [
    ...
    {'1': 'contract', '3': 11, '4': 3, '5': 11, '6': '.protocol.Transaction.Contract', '10': 'contract'},
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    'CgtUcmFuc2FjdGlvbhI0CghyYXdfZGF0YRgBIAEoCzIZLnByb3RvY29sLlRyYW5zYWN0aW9uLn'
...
const TransactionInfo$json = {
  ...
  '2': [
    ...
    {'1': 'withdraw_amount', '3': 15, '4': 1, '5': 3, '10': 'withdrawAmount'},
    {'1': 'unfreeze_amount', '3': 16, '4': 1, '5': 3, '10': 'unfreezeAmount'},
    {'1': 'internal_transactions', '3': 17, '4': 3, '5': 11, '6': '.protocol.InternalTransaction', '10': 'internalTransactions'},
    {'1': 'exchange_received_amount', '3': 18, '4': 1, '5': 3, '10': 'exchangeReceivedAmount'},
    {'1': 'exchange_inject_another_amount', '3': 19, '4': 1, '5': 3, '10': 'exchangeInjectAnotherAmount'},
    {'1': 'exchange_withdraw_another_amount', '3': 20, '4': 1, '5': 3, '10': 'exchangeWithdrawAnotherAmount'},
    {'1': 'exchange_id', '3': 21, '4': 1, '5': 3, '10': 'exchangeId'},
    ...
    {'1': 'cancel_unfreezeV2_amount', '3': 29, '4': 3, '5': 11, '6': '.protocol.TransactionInfo.CancelUnfreezeV2AmountEntry', '10': 'cancelUnfreezeV2Amount'},
  ],
...
final $typed_data.Uint8List transactionInfoDescriptor = $convert.base64Decode(
    'Cg9UcmFuc2FjdGlvbkluZm8SDgoCaWQYASABKAxSAmlkEhAKA2ZlZRgCIAEoA1IDZmVlEiAKC2'
...
const TransactionRet$json = {
  ...
  '2': [
    ...
    {'1': 'transactioninfo', '3': 3, '4': 3, '5': 11, '6': '.protocol.TransactionInfo', '10': 'transactioninfo'},
  ],
};
...
final $typed_data.Uint8List transactionRetDescriptor = $convert.base64Decode(
    'Cg5UcmFuc2FjdGlvblJldBIgCgtibG9ja051bWJlchgBIAEoA1ILYmxvY2tOdW1iZXISJgoOYm'
...
const Transactions$json = {
  '1': 'Transactions',
  '2': [
    {'1': 'transactions', '3': 1, '4': 3, '5': 11, '6': '.protocol.Transaction', '10': 'transactions'},
  ],
};
...
final $typed_data.Uint8List transactionsDescriptor = $convert.base64Decode(
    'CgxUcmFuc2FjdGlvbnMSOQoMdHJhbnNhY3Rpb25zGAEgAygLMhUucHJvdG9jb2wuVHJhbnNhY3'
...
final $typed_data.Uint8List blockHeaderDescriptor = $convert.base64Decode(
    'CgtCbG9ja0hlYWRlchI0CghyYXdfZGF0YRgBIAEoCzIZLnByb3RvY29sLkJsb2NrSGVhZGVyLn'
...
final $typed_data.Uint8List blockDescriptor = $convert.base64Decode(
    'CgVCbG9jaxI5Cgx0cmFuc2FjdGlvbnMYASADKAsyFS5wcm90b2NvbC5UcmFuc2FjdGlvblIMdH'
...
final $typed_data.Uint8List chainInventoryDescriptor = $convert.base64Decode(
    'Cg5DaGFpbkludmVudG9yeRIyCgNpZHMYASADKAsyIC5wcm90b2NvbC5DaGFpbkludmVudG9yeS'
...
final $typed_data.Uint8List blockInventoryDescriptor = $convert.base64Decode(
    'Cg5CbG9ja0ludmVudG9yeRIyCgNpZHMYASADKAsyIC5wcm90b2NvbC5CbG9ja0ludmVudG9yeS'
...
final $typed_data.Uint8List inventoryDescriptor = $convert.base64Decode(
    'CglJbnZlbnRvcnkSNQoEdHlwZRgBIAEoDjIhLnByb3RvY29sLkludmVudG9yeS5JbnZlbnRvcn'
...
const Items$json = {
  ...
  '2': [
    ...
    {'1': 'block_headers', '3': 3, '4': 3, '5': 11, '6': '.protocol.BlockHeader', '10': 'blockHeaders'},
    {'1': 'transactions', '3': 4, '4': 3, '5': 11, '6': '.protocol.Transaction', '10': 'transactions'},
  ],
...
final $typed_data.Uint8List itemsDescriptor = $convert.base64Decode(
    'CgVJdGVtcxIsCgR0eXBlGAEgASgOMhgucHJvdG9jb2wuSXRlbXMuSXRlbVR5cGVSBHR5cGUSJw'
...
final $typed_data.Uint8List dynamicPropertiesDescriptor = $convert.base64Decode(
    'ChFEeW5hbWljUHJvcGVydGllcxI1ChdsYXN0X3NvbGlkaXR5X2Jsb2NrX251bRgBIAEoA1IUbG'
...
final $typed_data.Uint8List disconnectMessageDescriptor = $convert.base64Decode(
    'ChFEaXNjb25uZWN0TWVzc2FnZRIsCgZyZWFzb24YASABKA4yFC5wcm90b2NvbC5SZWFzb25Db2'
    'RlUgZyZWFzb24=');
...
const HelloMessage$json = {
  ...
  '2': [
    ...
    {'1': 'genesisBlockId', '3': 4, '4': 1, '5': 11, '6': '.protocol.HelloMessage.BlockId', '10': 'genesisBlockId'},
    {'1': 'solidBlockId', '3': 5, '4': 1, '5': 11, '6': '.protocol.HelloMessage.BlockId', '10': 'solidBlockId'},
    {'1': 'headBlockId', '3': 6, '4': 1, '5': 11, '6': '.protocol.HelloMessage.BlockId', '10': 'headBlockId'},
...
final $typed_data.Uint8List helloMessageDescriptor = $convert.base64Decode(
    'CgxIZWxsb01lc3NhZ2USJgoEZnJvbRgBIAEoCzISLnByb3RvY29sLkVuZHBvaW50UgRmcm9tEh'
...
const InternalTransaction$json = {
  ...
  '2': [
    ...
    {'1': 'callValueInfo', '3': 4, '4': 3, '5': 11, '6': '.protocol.InternalTransaction.CallValueInfo', '10': 'callValueInfo'},
...
final $typed_data.Uint8List internalTransactionDescriptor = $convert.base64Decode(
    'ChNJbnRlcm5hbFRyYW5zYWN0aW9uEhIKBGhhc2gYASABKAxSBGhhc2gSJQoOY2FsbGVyX2FkZH'
...
final $typed_data.Uint8List delegatedResourceAccountIndexDescriptor = $convert.base64Decode(
    'Ch1EZWxlZ2F0ZWRSZXNvdXJjZUFjY291bnRJbmRleBIYCgdhY2NvdW50GAEgASgMUgdhY2NvdW'
...
const NodeInfo$json = {
  ...
  '2': [
    ...
    {'1': 'peerInfoList', '3': 8, '4': 3, '5': 11, '6': '.protocol.NodeInfo.PeerInfo', '10': 'peerInfoList'},
    {'1': 'configNodeInfo', '3': 9, '4': 1, '5': 11, '6': '.protocol.NodeInfo.ConfigNodeInfo', '10': 'configNodeInfo'},
    {'1': 'machineInfo', '3': 10, '4': 1, '5': 11, '6': '.protocol.NodeInfo.MachineInfo', '10': 'machineInfo'},
    {'1': 'cheatWitnessInfoMap', '3': 11, '4': 3, '5': 11, '6': '.protocol.NodeInfo.CheatWitnessInfoMapEntry', '10': 'cheatWitnessInfoMap'},
  ],
  '3': [NodeInfo_CheatWitnessInfoMapEntry$json, NodeInfo_PeerInfo$json, NodeInfo_ConfigNodeInfo$json, NodeInfo_MachineInfo$json],
};
...
const NodeInfo_MachineInfo$json = {
  ...
  '2': [
    ...
    {'1': 'memoryDescInfoList', '3': 12, '4': 3, '5': 11, '6': '.protocol.NodeInfo.MachineInfo.MemoryDescInfo', '10': 'memoryDescInfoList'},
    {'1': 'deadLockThreadInfoList', '3': 13, '4': 3, '5': 11, '6': '.protocol.NodeInfo.MachineInfo.DeadLockThreadInfo', '10': 'deadLockThreadInfoList'},
  ],
...
final $typed_data.Uint8List nodeInfoDescriptor = $convert.base64Decode(
    'CghOb2RlSW5mbxIiCgxiZWdpblN5bmNOdW0YASABKANSDGJlZ2luU3luY051bRIUCgVibG9jax'
...
const MetricsInfo$json = {
  ...
  '2': [
    ...
    {'1': 'blockchain', '3': 3, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.BlockChainInfo', '10': 'blockchain'},
    {'1': 'net', '3': 4, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.NetInfo', '10': 'net'},
  ],
  '3': [MetricsInfo_NodeInfo$json, MetricsInfo_BlockChainInfo$json, MetricsInfo_RateInfo$json, MetricsInfo_NetInfo$json],
};
...
const MetricsInfo_BlockChainInfo$json = {
  ...
  '2': [
    ...
    {'1': 'blockProcessTime', '3': 6, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'blockProcessTime'},
    {'1': 'tps', '3': 7, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'tps'},
    {'1': 'transactionCacheSize', '3': 8, '4': 1, '5': 5, '10': 'transactionCacheSize'},
    {'1': 'missedTransaction', '3': 9, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'missedTransaction'},
    {'1': 'witnesses', '3': 10, '4': 3, '5': 11, '6': '.protocol.MetricsInfo.BlockChainInfo.Witness', '10': 'witnesses'},
    {'1': 'failProcessBlockNum', '3': 11, '4': 1, '5': 3, '10': 'failProcessBlockNum'},
    {'1': 'failProcessBlockReason', '3': 12, '4': 1, '5': 9, '10': 'failProcessBlockReason'},
    {'1': 'dupWitness', '3': 13, '4': 3, '5': 11, '6': '.protocol.MetricsInfo.BlockChainInfo.DupWitness', '10': 'dupWitness'},
  ],
...
const MetricsInfo_NetInfo$json = {
  ...
  '2': [
    ...
    {'1': 'api', '3': 2, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.NetInfo.ApiInfo', '10': 'api'},
    {'1': 'connectionCount', '3': 3, '4': 1, '5': 5, '10': 'connectionCount'},
    {'1': 'validConnectionCount', '3': 4, '4': 1, '5': 5, '10': 'validConnectionCount'},
    {'1': 'tcpInTraffic', '3': 5, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'tcpInTraffic'},
    {'1': 'tcpOutTraffic', '3': 6, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'tcpOutTraffic'},
    {'1': 'disconnectionCount', '3': 7, '4': 1, '5': 5, '10': 'disconnectionCount'},
    {'1': 'disconnectionDetail', '3': 8, '4': 3, '5': 11, '6': '.protocol.MetricsInfo.NetInfo.DisconnectionDetailInfo', '10': 'disconnectionDetail'},
    {'1': 'udpInTraffic', '3': 9, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'udpInTraffic'},
    {'1': 'udpOutTraffic', '3': 10, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'udpOutTraffic'},
    {'1': 'latency', '3': 11, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.NetInfo.LatencyInfo', '10': 'latency'},
  ],
  '3': [MetricsInfo_NetInfo_ApiInfo$json, MetricsInfo_NetInfo_DisconnectionDetailInfo$json, MetricsInfo_NetInfo_LatencyInfo$json],
};
...
const MetricsInfo_NetInfo_ApiInfo$json = {
  ...
  '2': [
    ...
    {'1': 'failQps', '3': 2, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'failQps'},
    {'1': 'outTraffic', '3': 3, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'outTraffic'},
    {'1': 'detail', '3': 4, '4': 3, '5': 11, '6': '.protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo', '10': 'detail'},
  ],
...
const MetricsInfo_NetInfo_ApiInfo_ApiDetailInfo$json = {
  ...
  '2': [
    ...
    {'1': 'failQps', '3': 3, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'failQps'},
    {'1': 'outTraffic', '3': 4, '4': 1, '5': 11, '6': '.protocol.MetricsInfo.RateInfo', '10': 'outTraffic'},
  ],
};
...
const MetricsInfo_NetInfo_LatencyInfo$json = {
  ...
  '2': [
    ...
    {'1': 'detail', '3': 8, '4': 3, '5': 11, '6': '.protocol.MetricsInfo.NetInfo.LatencyInfo.LatencyDetailInfo', '10': 'detail'},
  ],
...
final $typed_data.Uint8List metricsInfoDescriptor = $convert.base64Decode(
    'CgtNZXRyaWNzSW5mbxIaCghpbnRlcnZhbBgBIAEoA1IIaW50ZXJ2YWwSMgoEbm9kZRgCIAEoCz'
...
const PBFTMessage_Raw$json = {
  '1': 'Raw',
  '2': [
    {'1': 'msg_type', '3': 1, '4': 1, '5': 14, '6': '.protocol.PBFTMessage.MsgType', '10': 'msgType'},
    {'1': 'data_type', '3': 2, '4': 1, '5': 14, '6': '.protocol.PBFTMessage.DataType', '10': 'dataType'},
...
final $typed_data.Uint8List pBFTMessageDescriptor = $convert.base64Decode(
    'CgtQQkZUTWVzc2FnZRI0CghyYXdfZGF0YRgBIAEoCzIZLnByb3RvY29sLlBCRlRNZXNzYWdlLl'
...
final $typed_data.Uint8List pBFTCommitResultDescriptor = $convert.base64Decode(
    'ChBQQkZUQ29tbWl0UmVzdWx0EhIKBGRhdGEYASABKAxSBGRhdGESHAoJc2lnbmF0dXJlGAIgAy'
    'gMUglzaWduYXR1cmU=');
...
final $typed_data.Uint8List sRLDescriptor = $convert.base64Decode(
    'CgNTUkwSHAoJc3JBZGRyZXNzGAEgAygMUglzckFkZHJlc3M=');
