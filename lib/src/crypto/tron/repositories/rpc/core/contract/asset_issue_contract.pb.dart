...
class AssetIssueContract_FrozenSupply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AssetIssueContract.FrozenSupply',
  ...
  AssetIssueContract_FrozenSupply copyWith(
      ...
      super.copyWith((message) => updates(message as AssetIssueContract_FrozenSupply))
          as AssetIssueContract_FrozenSupply;
  ...
  static AssetIssueContract_FrozenSupply getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AssetIssueContract_FrozenSupply>(create);
...
class AssetIssueContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetIssueContract',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'),
      createEmptyInstance: create)
    ...
    ..pc<AssetIssueContract_FrozenSupply>(
        5, _omitFieldNames ? '' : 'frozenSupply', $pb.PbFieldType.PM,
  ...
  AssetIssueContract copyWith(void Function(AssetIssueContract) updates) =>
      super.copyWith((message) => updates(message as AssetIssueContract)) as AssetIssueContract;
  ...
  @$core.pragma('dart2js:noInline')
  static AssetIssueContract getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AssetIssueContract>(create);
...
class UpdateAssetContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateAssetContract',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  UpdateAssetContract copyWith(void Function(UpdateAssetContract) updates) =>
      super.copyWith((message) => updates(message as UpdateAssetContract)) as UpdateAssetContract;
  ...
  @$core.pragma('dart2js:noInline')
  static UpdateAssetContract getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateAssetContract>(create);
...
class ParticipateAssetIssueContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ParticipateAssetIssueContract',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ParticipateAssetIssueContract copyWith(void Function(ParticipateAssetIssueContract) updates) =>
      super.copyWith((message) => updates(message as ParticipateAssetIssueContract))
          as ParticipateAssetIssueContract;
  ...
  @$core.pragma('dart2js:noInline')
  static ParticipateAssetIssueContract getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ParticipateAssetIssueContract>(create);
