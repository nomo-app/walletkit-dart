...
const SmartContract$json = {
  ...
  '2': [
    ...
    {'1': 'consume_user_resource_percent', '3': 6, '4': 1, '5': 3, '10': 'consumeUserResourcePercent'},
...
const SmartContract_ABI$json = {
  '1': 'ABI',
  '2': [
    {'1': 'entrys', '3': 1, '4': 3, '5': 11, '6': '.protocol.SmartContract.ABI.Entry', '10': 'entrys'},
  ],
...
const SmartContract_ABI_Entry$json = {
  ...
  '2': [
    ...
    {'1': 'inputs', '3': 4, '4': 3, '5': 11, '6': '.protocol.SmartContract.ABI.Entry.Param', '10': 'inputs'},
    {'1': 'outputs', '3': 5, '4': 3, '5': 11, '6': '.protocol.SmartContract.ABI.Entry.Param', '10': 'outputs'},
    {'1': 'type', '3': 6, '4': 1, '5': 14, '6': '.protocol.SmartContract.ABI.Entry.EntryType', '10': 'type'},
    {'1': 'payable', '3': 7, '4': 1, '5': 8, '10': 'payable'},
    {'1': 'stateMutability', '3': 8, '4': 1, '5': 14, '6': '.protocol.SmartContract.ABI.Entry.StateMutabilityType', '10': 'stateMutability'},
  ],
...
final $typed_data.Uint8List smartContractDescriptor = $convert.base64Decode(
    'Cg1TbWFydENvbnRyYWN0EiUKDm9yaWdpbl9hZGRyZXNzGAEgASgMUg1vcmlnaW5BZGRyZXNzEi'
...
final $typed_data.Uint8List contractStateDescriptor = $convert.base64Decode(
    'Cg1Db250cmFjdFN0YXRlEiEKDGVuZXJneV91c2FnZRgBIAEoA1ILZW5lcmd5VXNhZ2USIwoNZW'
...
const CreateSmartContract$json = {
  ...
  '2': [
    ...
    {'1': 'new_contract', '3': 2, '4': 1, '5': 11, '6': '.protocol.SmartContract', '10': 'newContract'},
...
final $typed_data.Uint8List createSmartContractDescriptor = $convert.base64Decode(
    'ChNDcmVhdGVTbWFydENvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAxSDG93bmVyQWRkcm'
...
final $typed_data.Uint8List triggerSmartContractDescriptor = $convert.base64Decode(
    'ChRUcmlnZ2VyU21hcnRDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgMUgxvd25lckFkZH'
...
final $typed_data.Uint8List clearABIContractDescriptor = $convert.base64Decode(
    'ChBDbGVhckFCSUNvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAxSDG93bmVyQWRkcmVzcx'
...
const UpdateSettingContract$json = {
  ...
  '2': [
    {'1': 'owner_address', '3': 1, '4': 1, '5': 12, '10': 'ownerAddress'},
    {'1': 'contract_address', '3': 2, '4': 1, '5': 12, '10': 'contractAddress'},
    {'1': 'consume_user_resource_percent', '3': 3, '4': 1, '5': 3, '10': 'consumeUserResourcePercent'},
  ],
};
...
final $typed_data.Uint8List updateSettingContractDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVTZXR0aW5nQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoDFIMb3duZXJBZG'
...
final $typed_data.Uint8List updateEnergyLimitContractDescriptor = $convert.base64Decode(
    'ChlVcGRhdGVFbmVyZ3lMaW1pdENvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAxSDG93bm'
...
const SmartContractDataWrapper$json = {
  ...
  '2': [
    {'1': 'smart_contract', '3': 1, '4': 1, '5': 11, '6': '.protocol.SmartContract', '10': 'smartContract'},
    {'1': 'runtimecode', '3': 2, '4': 1, '5': 12, '10': 'runtimecode'},
    {'1': 'contract_state', '3': 3, '4': 1, '5': 11, '6': '.protocol.ContractState', '10': 'contractState'},
  ],
};

/// Descriptor for `SmartContractDataWrapper`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List smartContractDataWrapperDescriptor = $convert.base64Decode(
    'ChhTbWFydENvbnRyYWN0RGF0YVdyYXBwZXISPgoOc21hcnRfY29udHJhY3QYASABKAsyFy5wcm'
