...
class MarketSellAssetContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarketSellAssetContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MarketSellAssetContract copyWith(void Function(MarketSellAssetContract) updates) => super.copyWith((message) => updates(message as MarketSellAssetContract)) as MarketSellAssetContract;
...
class MarketCancelOrderContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarketCancelOrderContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MarketCancelOrderContract copyWith(void Function(MarketCancelOrderContract) updates) => super.copyWith((message) => updates(message as MarketCancelOrderContract)) as MarketCancelOrderContract;
