...
class ExchangeCreateContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangeCreateContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ExchangeCreateContract copyWith(void Function(ExchangeCreateContract) updates) => super.copyWith((message) => updates(message as ExchangeCreateContract)) as ExchangeCreateContract;
...
class ExchangeInjectContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangeInjectContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExchangeInjectContract copyWith(void Function(ExchangeInjectContract) updates) => super.copyWith((message) => updates(message as ExchangeInjectContract)) as ExchangeInjectContract;
...
class ExchangeWithdrawContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangeWithdrawContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
    ..aInt64(2, _omitFieldNames ? '' : 'exchangeId')
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'tokenId', $pb.PbFieldType.OY)
    ..aInt64(4, _omitFieldNames ? '' : 'quant')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExchangeWithdrawContract copyWith(void Function(ExchangeWithdrawContract) updates) => super.copyWith((message) => updates(message as ExchangeWithdrawContract)) as ExchangeWithdrawContract;
...
class ExchangeTransactionContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangeTransactionContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
    ..aInt64(2, _omitFieldNames ? '' : 'exchangeId')
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'tokenId', $pb.PbFieldType.OY)
    ..aInt64(4, _omitFieldNames ? '' : 'quant')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExchangeTransactionContract copyWith(void Function(ExchangeTransactionContract) updates) => super.copyWith((message) => updates(message as ExchangeTransactionContract)) as ExchangeTransactionContract;
