...
class BuyStorageBytesContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuyStorageBytesContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BuyStorageBytesContract copyWith(void Function(BuyStorageBytesContract) updates) => super.copyWith((message) => updates(message as BuyStorageBytesContract)) as BuyStorageBytesContract;
...
class BuyStorageContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuyStorageContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuyStorageContract copyWith(void Function(BuyStorageContract) updates) => super.copyWith((message) => updates(message as BuyStorageContract)) as BuyStorageContract;
...
class SellStorageContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SellStorageContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SellStorageContract copyWith(void Function(SellStorageContract) updates) => super.copyWith((message) => updates(message as SellStorageContract)) as SellStorageContract;
...
class UpdateBrokerageContract extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateBrokerageContract', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'ownerAddress', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateBrokerageContract copyWith(void Function(UpdateBrokerageContract) updates) => super.copyWith((message) => updates(message as UpdateBrokerageContract)) as UpdateBrokerageContract;
