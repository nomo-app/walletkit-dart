...
class InventoryItems extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InventoryItems', package: const $pb.PackageName(_omitMessageNames ? '' : 'protocol'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InventoryItems copyWith(void Function(InventoryItems) updates) => super.copyWith((message) => updates(message as InventoryItems)) as InventoryItems;
