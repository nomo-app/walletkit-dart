...
//   final int maximumFeeRate;
//   final List<ElectrumInput> _inputs;
//   late RawTransaction _tx;
//   Map _prevTxSet = {};
...
//     required this.maximumFeeRate,
//   })  : _inputs = [],
//         _tx = RawTransaction(version: 2, lockTime: 0);

//   List<ElectrumInput> get inputs => _inputs;
...
//   bool _canSign(ElectrumInput input) {
...
//   _addInputUnsafe(Uint8List hash, int vout, ElectrumInput options) {
...
//       input = ElectrumInput.expandInput(
//           options.script, options.witness ?? EMPTY_WITNESS);
//     } else {
//       input = new ElectrumInput();
//     }
...
//         var expanded = ElectrumOutput.expandOutput(options.prevOutScript);
