...
void main() {
  ...
  group("Generate Mnemonic with different lengths", () {
  ...
  group("Validate Mnemonic", () {
    test(
      'french phrase generated by legacy app: Test Unicode Replacement',
      () async {
        const frPhrase =
    ...
    test(
      'spanish phrase generated by legacy app: Test Unicode Replacement',
      () async {
        const esPhrase =
    ...
    test(
      "Japanese phrase generated by legacy app: Test Unicode Replacement",
      () async {
        const jpPhrase =
  ...
  group('invalid entropy', () {
    ...
    test('throws for entropy that is larger than 1024', () {
      try {
        expect(
          entropyToMnemonic(Uint8List(1028 + 1).join('00')),
          throwsArgumentError,
        );
      } catch (err) {
        expect((err as ArgumentError).message, "Invalid entropy");
